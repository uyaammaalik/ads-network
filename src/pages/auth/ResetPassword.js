    ...
    return (
        <div>
            ...
            rounded-lg md:w-2/6 lg:w-2/6 mx-auto mt-5 flex flex-col mt-8 drop-shadow-lg">
                ...
                {success ? <p className='text-center'>Your Password is successfully reset</p> : <>
                    ...
                    <div className="flex flex-row my-5 mx-auto">
                        ...
                        <button
                            className="border-y rounded-md w-40 border-slate-500 px-3 py-3 hover:shadow-lg hover:border-x">Reset</button>
                        <input type="reset"
